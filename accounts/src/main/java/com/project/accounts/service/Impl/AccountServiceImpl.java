...
public class AccountServiceImpl implements IAccountsService {
    ...
    public CustomerDTO fetchAccount(String mobileNumber) {
        ...
        Account account = this.accountRepository.findByCustomerId(customer.getCustomerId()).orElseThrow(() -> new ResourceNotFoundException("Account", "customerId", customer.getCustomerId().toString()));
    ...
    public boolean updateAccount(CustomerDTO customerDTO) {
        ...
        if (accountsDto != null) {
            Account account = this.accountRepository.findById(accountsDto.getAccountNumber()).orElseThrow(() -> new ResourceNotFoundException("Account", "AccountNumber", accountsDto.getAccountNumber().toString()));
